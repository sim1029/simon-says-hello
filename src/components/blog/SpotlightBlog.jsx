...
function SpotlightBlog({ post }) {
	console.log("SPOTLIGHT POST", post);
	return (
		<Link to={`/blog/${post.slug}`} className="contents">
			<div className="group mx-2 flex flex-col items-center gap-y-8 rounded-xl bg-slate-300 p-8 shadow-md hover:cursor-pointer dark:bg-gray-700">
